...
// main card
function getData() {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=95b632d7620a33c0ed4bdb96d9814509"
    mainCard.empty();
    ...
    $.ajax({
        ...
        $.ajax({
            url: "http://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&appid=95b632d7620a33c0ed4bdb96d9814509",
            method: "GET"
        ...
        $.ajax({
            url: "http://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=95b632d7620a33c0ed4bdb96d9814509",
            method: "GET"
